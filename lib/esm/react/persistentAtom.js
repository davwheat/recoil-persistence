 ...
 *          )
 */
export function persistentAtom(atomOptions, persistOptions) {
    ...
    var finalOptions = __assign(__assign({}, atomOptions), { effects_UNSTABLE: __spreadArray(__spreadArray([], (existingEffects || [])), [storageEffect(key, persistOptions === null || persistOptions === void 0 ? void 0 : persistOptions.storage, persistOptions === null || persistOptions === void 0 ? void 0 : persistOptions.validator)]) });
    return atom(finalOptions);
}
